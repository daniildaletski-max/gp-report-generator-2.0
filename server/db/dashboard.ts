  ...
  try {
    ...
    for (const s of stale) {
      insights.push({
        ...
        description: `Last evaluation was ${s.daysSince} days ago. A fresh one keeps coaching data current.`,
  ...
  try {
    ...
    for (const a of atRisk) {
      ...
      insights.push({
        ...
        description: `${parts.join(" and ")} this month. Worth a conversation before it becomes a pattern.`,
