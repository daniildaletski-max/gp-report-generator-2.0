      ...
      <div className="relative" ref={sidebarRef}>
        ...
        >
          ...
          <SidebarFooter className="p-3 border-t border-primary/10">
            ...
            <button
              onClick={() => toggleTheme?.()}
              className="flex items-center gap-3 rounded-xl px-2 py-2.5 hover:bg-primary/10 transition-all duration-200 w-full text-left group-data-[collapsible=icon]:justify-center text-muted-foreground hover:text-foreground"
