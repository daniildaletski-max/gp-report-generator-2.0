  ...
  return (
    <div className="space-y-6 p-4 md:p-6 min-h-screen animate-fade-in">
      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "evaluations" | "attitude")} className="w-full">
        <TabsList className="grid w-full max-w-md grid-cols-2 bg-muted/50 border border-border rounded-xl p-1">
          <TabsTrigger value="evaluations" className="flex items-center gap-2 data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary/20 data-[state=active]:to-primary/20 data-[state=active]:border-primary/30 rounded-lg transition-all">
